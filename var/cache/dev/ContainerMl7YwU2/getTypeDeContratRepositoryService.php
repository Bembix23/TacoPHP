 ...
 */
class getTypeDeContratRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeDeContratRepository' shared autowired service.
     *
     * @return \App\Repository\TypeDeContratRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeDeContratRepository.php';

        return $container->privates['App\\Repository\\TypeDeContratRepository'] = new \App\Repository\TypeDeContratRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
